...
//All Rights Reserved
//
//Filename    : XyExceptionDotsPerUnitMeasureValueUndefined.java
//Author      : Rob Davis
//Version     : %R%.%L%
//Last Update : %G% at %U%
//By          : Rob Davis
...
public class XyExceptionDotsPerUnitMeasureValueUndefined extends Exception
{
	/**
	 *  R = Release L = Level G = date U = time
	 */
	public static final String sccsid = "@(#)Xyratex  ISTP  XyExceptionDotsPerUnitMeasureValueUndefined.java  %R%.%L%, %G% %U%";
  ...
  + NumberUtils.toLong("%L%");
	 ...
	 */
	public static final String NOT_DEFINED = "Dots per unit of measure value not defined.";
	 ...
	 */
 public XyExceptionDotsPerUnitMeasureValueUndefined( String detail )
 {
 	super ( detail + "\n" + sccsid );
 }
}
